...
function fmtAt(c: string | null) { if (!c) return "-"; const d = new Date(c); return d.toLocaleString("ko-KR", { month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit" }) }

function InvestorTradingTab({ symbol, start, end, page, pageSize, onPageChange, onPageSizeChange }: Props) {
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-right">외국인 순매수</TableHead>
              <TableHead className="text-right">기관 순매수</TableHead>
              <TableHead className="text-right">개인 순매수</TableHead>
              <TableHead className="text-right">외국인 매수</TableHead>
              <TableHead className="text-right">외국인 매도</TableHead>
              <TableHead className="text-right">기관 매수</TableHead>
              <TableHead className="text-right">기관 매도</TableHead>
